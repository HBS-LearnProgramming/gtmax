        ...
        <div class="flex items-center">
            <div>
                ...
                <div class="flex gap-4 mt-2">
                    ...
                    <a target="_blank" class="rounded" href="https://www.tiktok.com/@shahalammotors?_r=1&_t=ZS-94o1wQeI1Y"><img class="icon_size" src="<?php echo get_template_directory_uri(); ?>/images/icon/tiktok-black.png" alt="" srcset=""></a>
                </div>
            </div>
        </div>
