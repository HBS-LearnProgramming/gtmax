...
if ( ! class_exists( 'EV_Bike_Shop_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class EV_Bike_Shop_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'ev_bike_shop_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function ev_bike_shop_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new EV_Bike_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'ev_bike_shop_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function ev_bike_shop_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new EV_Bike_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
