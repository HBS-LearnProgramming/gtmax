...
function ev_bike_shop_enqueue_google_fonts() {
	...
	wp_enqueue_style(
		'Figtree',
		ev_bike_shop_wptt_get_webfont_url( 'https://fonts.googleapis.com/css2?family=Figtree:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap' ),
		array(),
		'1.0'
	);
	...
	echo '<div class="notice notice-info wpele-activation-notice is-dismissible">';
		echo '<div class="notice-body">';
			echo '<div class="notice-content">';
				...
				echo '<p>'. esc_html__( 'Thank you for choosing EV Bike Shop theme .To setup the theme, please visit the get started page.', 'ev-bike-shop' ) .'</p>';
				echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=ev_bike_shop_about' ) ) .'" class="button button-notice">'. esc_html__( 'GET STARTED', 'ev-bike-shop' ) .'</a></span>';
				echo '<span><a href="'. esc_url( EV_BIKE_SHOP_BUY_NOW ) .'" class="button button-notice" target="_blank" >'. esc_html__( 'BUY NOW', 'ev-bike-shop' ) .'</a></span>';
				echo '<span><a href="'. esc_url( EV_BIKE_SHOP_LIVE_DEMO ) .'" class="button button-notice" target="_blank" >'. esc_html__( 'DEMO', 'ev-bike-shop' ) .'</a></span>';
			echo '</div>';
...
function ev_bike_shop_enqueue_setting() {
...
add_action('after_setup_theme', 'ev_bike_shop_enqueue_setting');
